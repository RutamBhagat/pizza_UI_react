    ...
    return (
      <Fragment>
        ...
        <section class="text-gray-600 body-font">
          <div class="container px-24 py-24 mx-auto flex items-center flex-col sm:flex-row">
            <div class="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
              <h2 class="text-xs text-brightRed tracking-widest font-medium title-font mb-1">
            ...
            <div class="flex md:ml-auto md:mr-0 mx-2 md:mx-auto items-center flex-shrink-0 space-x-4">
              <button class="bg-gray-600 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-700 focus:outline-none">
                <svg
                ...
                <span class="ml-4 flex items-start flex-col leading-none">
                  <span class="text-xs text-gray-200 mb-1">PLACE ORDER</span>
                  <span class="title-font text-gray-200 font-medium">
                    PAY NOW
                  </span>
                </span>
              </button>
          ...
          <div class="container px-5 pt-24 mx-auto">
            <div class="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto">
              ...
              <button
                ...
                class="flex-shrink-0 text-white bg-brightRed border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg mt-10 sm:mt-0"
              >
                Wishlist
              </button>
            </div>
